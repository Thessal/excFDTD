...
for ind=[0:5:900]
    a=importdata(num2str(ind,'Ex_Y0_00%03d.txt'));
    b=importdata(num2str(ind,'Ey_Y0_00%03d.txt'));
    c=importdata(num2str(ind,'Ez_Y0_00%03d.txt'));
    t=10*(sqrt(a.^2+b.^2+c.^2));
    image(t(9+60:end-8-30,9:end-8)); colorbar(); colormap('hot'); set(gca,'Ydir','normal')
    saveas(gcf,num2str(ind,'E2_Y0_00%03d.png'));
end